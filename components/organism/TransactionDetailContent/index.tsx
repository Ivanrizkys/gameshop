                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                            ...
                            <div className="purchase pt-30">
                                ...
                                <Row title="Price" value={12000000} />
                                <Row title="Tax (10%)" value={20000000} />
                                <Row title="Total" value={40000000} className="color-palette-4" />
                            </div>
                            <div className="payment pt-10 pb-10">
                                ...
                                <Row title="Bank Number" value="1800 - 9090 - 2021" className="color-palette-1" />
                            </div>
